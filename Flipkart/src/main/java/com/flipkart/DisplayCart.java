...
public class DisplayCart extends HttpServlet {
	...
	public void service(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		try {
			...
			String selectQueryString = "select * from "+ tableNameString +"cart"; 
			...
			while(rSet.next()) {
				...
				pw.print("<th><a href='OrderServlet?id="+rSet.getInt(1)+"'><button class='order'>Order</button></a>&nbsp;<a href='DeleteServlet?id="+rSet.getInt(1)+"'><button class='cancel'>Cancel</button></a></th>");
				pw.print("</tr>");
			}
			pw.print("<tr><td colspan='6'><a href='#'><button>checkout</button></a></td></tr>");
			pw.print("</table>");
			pw.print("</body>");
			pw.print("</html>");
			statement.close();
